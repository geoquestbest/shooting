<?php
  ...
  $have_made = (mb_strpos(strtolower(trim($row_orders['selected_options'])), 'je fais réaliser sur-mesure') !== false && strpos($row_orders['select_type'], 'entreprise') !== false);
  $personal = (mb_strpos(strtolower(trim($row_orders['selected_options'])), 'contour personnalisé') !== false || mb_strpos(strtolower(trim($row_orders['selected_options'])), 'réaliser sur-mesure') !== false);
...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/index.min.css?v=1.4.0" />
  ...
  <body>
    ...
    <div class="container">
      <div class="wraper">
        ...
        <main class="main">
          <section class="contour <?php if ($personal === false || ($row_orders['image'] != '' && $row_orders['template_status'] != 0)) {echo " hidden";} ?>">
            <div class="contour-container">
              ...
              <form class="form contour-form<?php if ($row_orders['gallery_valid'] == 1) {echo" form--file";} ?>">
                ...
                <div class="form-fields">
                  ...
                  <div class="form-field">
                    <label for="code" class="form-field__label">Code couleur</label>
                    <input
                      type="text"
                      class="form-field__input"
                      id="code"
                ...
                <div class="form-valid">
                  ...
                  <button class="valid-btn" type="submit" id="gallery_valid" <?php if ($row_orders['gallery_valid'] == 1) {echo" disabled";} ?>>Valider</button>
                </div>
              </form>
            </div>

            <p class="text">
              <!--N’hésitez pas à demander team facturation pour toutes questions ou indications supplémentaires.-->N’hésitez pas à nous contacter au 07 56 85 85 35 pour toutes questions.
            </p>
          </section>
          ...
          <section class="contour contour--visualize<?php if (($row_orders['image'] == '' || $row_orders['template_status'] == 0) && mysqli_num_rows($result_orders_images) == 0) {echo " hidden";} ?>">
            <div class="contour-container">
              <h1 class="contour-title">Contour photo</h1>
              <img
                src="./img/contour/trait.svg"
                ...
                <?php
                  ...
                  if ($row_orders['image'] != '' && $row_orders['template_status'] == 1) {
                    ...
                    echo'<div class="visualize-item visualize-item--gray">
                      ...
                      <a href="contour_photo.php?event=unvalider" class="item-eye">
                  ...
                  while($row_orders_images = mysqli_fetch_assoc($result_orders_images)) {
                    ...
                    echo'<div class="visualize-item visualize-item--gray">
                      ...
                      <a href="contour_photo.php?event=unvalider&id='.$row_orders_images['id'].'" class="item-eye">
                        <img src="./img/contour/eye.svg" alt="contour-eye" />
                      </a>
                    </div>';
                  }
          ...
          <section class="contour contour--load contour--ou <?php if ($have_made !== false || $personal !== false) {echo " hidden";} ?>">
            <div class="contour-container">
              <h1 class="contour-title">Contour photo</h1>
              <img
                class="contour-img"
              ...
              <p class="contour-description contour-description-remove<?php echo ($row_orders['without_photo_frame'] == 1 ? ' hidden' : ''); ?>">
                Vous pouvez accéder à votre outil en ligne et commencer la création de votre contour photo. Merci de respecter la deadline sinon nos équipes ne seront pas en mesure d’assurer dans les temps la création de votre contour photo. Un contour blanc sera alors automatiquement appliqué.
              </p>
            </div>
              ...
              <div class="form-field form-field__row">
                ...
                <div class="contour-items" style="margin-bottom: 30px;">
                  <?php if ($row_orders['image'] == "") {?>
                    <button class="contour-btn" style="margin-left: 45px;">
                      <span class="btn-icon">
                ...
                <?php if (strpos($row_orders['select_type'], 'entreprise') === false) {
                    echo'<h2 class="contour-center">ou</h2>';
                    switch($row_orders['box_type']) {
                      case "Ring":
                      case "Ring_promotionnel":
                        echo '<a href="./Exemples contours/Exemples Contours Photos - Particulier - Ring.pdf" target="_blank">
