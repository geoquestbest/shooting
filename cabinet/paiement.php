                ...
                <div class="form-fields">
                  ...
                  <div class="form-field">
                    <label for="address_pdf" class="form-field__label">
                      Adresse de facturation <span class="required">*</span>
                    </label>
                  ...
                  <div class="form-field">
                    <label for="number_pdf" class="form-field__label">
                      Numéro de siret <span class="required">*</span>
                    </label>
                    <input
                      type="text"
                      class="form-field__input"
                  ...
                  <div class="form-field form-field__checkboxes col-mobile">
                  ...
                  <div class="form-valid">
                    <h3 class="valid-title">Si besoin,</h3>
                    <p class="valid-description">
                      vous pouvez importer des documents ici
                    </p>
                  ...
                  <?php if ($row_orders['deposit_link'] != "" && $row_orders['payment_status'] == 0) { ?>
                    <div class="paiement-step" style="width: 35%; margin: 10px auto 60px;">
          ...
          <div class="wraper-popup">
              <div class="popup">
                <img
                  ...
                  alt="close"
                  class="popup-close"
                 onClick="closePopup('.wraper-popup')" />
                ...
                <button class="popup-btn popup-btn--active" onClick="closePopup('.wraper-popup')">Retour</button>
                <button class="popup-btn" onclick="valider()">Valider</button>
              </div>
            </div>
        </main>
      </div>
