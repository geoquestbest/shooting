...
<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
	<div class="panel-heading">
		...
		<h4 class="panel-title"><?php echo ADDING_TYPE ?></h4>
	</div>
	<div class="panel-body">
		<form class="form-horizontal add-type">
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control title" placeholder="<?php echo TYPE ?>" />
				</div>
			</div>
			<div class="form-group">
	...
	$(document).ready(function() {
		...
		$('.add-type').on('submit', function(event){
			...
			$.ajax({
				type: 'POST',
				url: 'd26386b04e.php',
				data: {event: 'add_type',  title: $('.title').val()},
				cache: false,
