<?php
	...
	$page_title = "Ajouter les Récuperation";
...
<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
	<div class="panel-heading">
		...
		<h4 class="panel-title">Ajouter les Récuperation</h4>
	</div>
	<div class="panel-body">
		<form class="form-horizontal add-recovery">
...
<script>
	...
	$(document).ready(function() {
		...
		$('.add-recovery').on('submit', function(event){
			...
			$.ajax({
				type: 'POST',
				url: 'd26386b04e.php',
				data: {event: 'add_recovery',  title: $('.title').val(), description: $('.description').val(), description_pdf: $('.description_pdf').val(), image: $('.image').val(), department: $('.department').val(), price: $('.price').val(), eprice: $('.eprice').val()},
				cache: false,
				success: function(responce){
					if (responce == 'done'){
						swal({
