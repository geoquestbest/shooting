...
text:function(a){return a.i18n("buttons.copy","<i class=\"fa fa-copy\"></i> Копировать")},action:function(a,b,d,c){a=B(b,c);c=a.str;d=g("<div/>").css({height:1,width:1,overflow:"hidden",position:"fixed",top:0,left:0});c=g("<textarea readonly/>").val(c).appendTo(d);if(f.queryCommandSupported("copy")){d.appendTo("body");c[0].focus();c[0].select();try{f.execCommand("copy");d.remove();b.buttons.info(b.i18n("buttons.copyTitle","Копирование в буфер обмена"),b.i18n("buttons.copySuccess",{1:"Скопирована одна строка в буфер обмена",_:"Скопировано %d строк в буфер обмена"},
a.rows),2E3);return}catch(i){}}a=g("<span>"+b.i18n("buttons.copyKeys","Нажмите <i>ctrl</i> или <i>âŒ˜</i> + <i>C</i> для копирования информации из таблицы<br>в буфер обмена.<br><br>Для закрытия данного сообщения нажмите Esc.")+"</span>").append(d);b.buttons.info(b.i18n("buttons.copyTitle","Копирование в буфер обмена"),a,0);c[0].focus();c[0].select();var h=g(a).closest(".dt-button-info"),j=function(){h.off("click.buttons-copy");g(f).off(".buttons-copy");b.buttons.info(!1)};h.on("click.buttons-copy",j);g(f).on("keydown.buttons-copy",
