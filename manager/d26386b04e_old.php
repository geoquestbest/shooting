...
if (isset($_SESSION['user'])) {
	...
	if ($event == "edit_stocks") {
		mysqli_query($conn, "UPDATE `settings` SET `ring` = '$ring', `vegas` = '$vegas', `vegas_slim` = '$vegas_slim', `miroir` = '$miroir', `spinner` = '$spinner', `vr` = '$vr' WHERE `id` = 1") or die(mysqli_error($conn));
		echo"done";
	}
                                        ...
                                        <td class="esd-stripe" align="center" style="padding:0;Margin:0;">
                                          <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#ffffff;">
                                            <tbody>
                                              ...
                                              <tr>
                                                <td class="esd-structure es-p25t es-p25b es-p25r es-p25l es-m-p10r es-m-p10l" align="left" style="padding:0;Margin:0;padding-top:25px;padding-bottom: 25px;padding-left:25px;padding-right:25px;">
                                                  <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                    <tbody>
                                                      <tr>
                                                            ...
                                                            <tbody>
                                                              ...
                                                              <tr>
                                                                <td class="esd-block-text" align="left" style="padding:0;Margin:0;">
                                                                  <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;line-height:150%;color:#333333;font-size:14px;font-size: 15px;"><strong>Merci pour votre confiance, et bienvenue dans l’aventure Shootnbox!</strong></p>
                                                                </td>
                                                              </tr>
                                                              <tr>
                                                                <td class="esd-block-text" esd-links-color="#333333" align="left" style="padding:0;Margin:0;">
                                                                  <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;line-height:150%;color:#333333;font-size:14px;font-size: 15px;">Il est temps de personnaliser votre contour photo. Pour cela, rien de plus<br>
                                                                    simple: rendez-vous sur notre outil en ligne en <a target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2cb543;font-size:14px;font-size: 15px; color: #333333;" href="https://ftp.shootnbox.fr/template/">cliquant ici.</a> Un large catalogue de créations préfabriquées et d’options de personnalisations vous attendent !</p>
                                                                </td>
                                                              </tr>
                                                              <tr>
                                                                <td class="esd-block-text" align="left" style="padding:0;Margin:0;">
                                                                  <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;line-height:150%;color:#333333;font-size:14px;font-size: 15px;">Attention, le lien n’est consultable que depuis un ordinateur.</p>
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                              ...
                                              <tr>
                                                <td class="esd-structure es-p5t es-p5b es-p25r es-p25l es-m-p10r es-m-p10l" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;padding-left:25px;padding-right:25px;background-color: #e23e8d; border-radius: 15px;" bgcolor="#e23e8d" align="left">
                                                  <!--[if mso]>
                                                    <table width="550" cellpadding="0" cellspacing="0">
                                                      <tr>
                                                        <td width="85" valign="top"><![endif]-->
                                                  <table class="es-left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left;" cellspacing="0" cellpadding="0" align="left">
                                                    <tbody>
                                                      <tr>
                                                        <td class="es-m-p0r esd-container-frame" style="padding:0;Margin:0;" width="85" valign="top" align="center">
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td class="esd-block-image" style="padding:0;Margin:0;font-size: 0px;" align="center">
                                                                  <a target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2cb543;font-size:14px;"><img src="https://ftp.shootnbox.fr/manager/mail/picto_photo.png" alt="" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;display: block;" width="74"></a>
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                  ...
                                                  <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" cellspacing="0" cellpadding="0" align="right">
                                                    <tbody>
                                                      <tr>
                                                        <td class="esd-container-frame" style="padding:0;Margin:0;" width="455" align="left">
                                                          <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                              <tr>
                                                                <td class="esd-block-text" esd-links-color="#ffffff" style="padding:0;Margin:0;" align="center">
                                                                  <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;line-height:150%;color:#333333;font-size:14px;color: #ffffff; font-size: 17px;">N’hésitez pas à consulter le tutoriel vidéo pour vous aider dans la conception de votre contour photo en <a target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2cb543;font-size:14px;font-size: 17px; color: #ffffff;" href="https://youtube.com/watch?v=0NltGV11wv4&feature=share">cliquant ICI</a></p>
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                              ...
                                              <tr>
                                                <td class="esd-structure es-p20t es-p20r es-p20l" style="padding:0;Margin:0;padding-top:20px;padding-left:20px;padding-right:20px;" align="left">
                                                  <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" width="100%" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                      <tr>
                                                        <td class="esd-container-frame" style="padding:0;Margin:0;" width="560" valign="top" align="center">
                                                          <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                              <tr>
                                                                <td class="esd-block-spacer es-p5" style="padding:0;Margin:0;padding:5px;font-size:0;" align="center">
                                                                  <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
                                                                    <tbody>
                                                                      <tr>
                                              ...
                                              <tr>
                                                <td class="esd-structure" style="padding:0;Margin:0;">
                                                  <!--[if mso]>
                                                    <table width="560" cellpadding="0" cellspacing="0">
                                                      <tr>
                                                        <td width="89" valign="top"><![endif]-->
                                                  <table style="padding-bottom:5px;padding-top:20px;padding-left:20px;padding-right:20px;border-left:2px solid #e23e8d;border-right:2px solid #e23e8d;border-top:2px solid #e23e8d;border-bottom:2px solid #e23e8d; border-radius:10px;" width="100%" cellspacing="0" cellpadding="0">
                                                      <tbody>
                                                          <tr>
                                                              <td>
                                                                  <table class="es-left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left;" cellspacing="0" cellpadding="0" align="left">
                                                                    <tbody>
                                                                      <tr>
                                                                        <td class="es-m-p0r esd-container-frame" style="padding:0;Margin:0;" width="89" valign="top" align="center">
                                                                          <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                              <tr>
                                                                                <td class="esd-block-image" style="padding:0;Margin:0;font-size: 0px;" align="center">
                                                                                  <a target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2cb543;font-size:14px;"><img src="https://ftp.shootnbox.fr/manager/mail/attention.png" alt="" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;display: block;" width="59"></a>
                                                                                </td>
                                                                              </tr>
                                                                            </tbody>
                                                                          </table>
                                                                  ...
                                                                  <!--[if mso]></td>
                                                                  <td width="10"></td>
                                                                  <td width="461" valign="top"><![endif]-->
                                                                  <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" cellspacing="0" cellpadding="0" align="right">
                                                                    <tbody>
                                                                      <tr>
                                                                        <td class="esd-container-frame" style="padding:0;Margin:0;" width="461" align="left">
                                                                          <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;" width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                              <tr>
                                                                                <td class="esd-block-text" style="padding:0;Margin:0;" align="left">
                                                                                  <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;line-height:150%;color:#333333;font-size:14px;font-size: 17px;">Notre outil de création en ligne est disponible <span style="color:#e23e8d;">jusqu’à 10 jours avant la date de votre événement.</span><br>
                                                                                    Passé ce délai, il ne sera plus possible de personnaliser votre contour photo et un cadre blanc standard sera appliqué automatiquement. Nous vous recommandons donc vivement de créer votre contour au plus vite !<br>
                                                                                  </p>
                                                                                </td>
                                                                              </tr>
                                                                            </tbody>
                                                      ...
                                                      <tr>
                                                        <td class="esd-container-frame" width="560" valign="top" align="center" style="padding:0;Margin:0;">
                                                          <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                            <tbody>
                                                              <tr>
                                                                <td class="esd-block-image" style="padding:0;Margin:0;font-size: 0px;" align="center"><a target="_blank" href="https://ftp.shootnbox.fr/cabinet/" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2cb543;font-size:14px;"><img src="https://ftp.shootnbox.fr/manager/mail/btn.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;display: block;" width="276"></a></td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                        </td>
                                                            ...
                                                            <tbody>
                                                              ...
                                                              <tr>
                                                                <td class="esd-block-text" esd-links-underline="none" esd-links-color="#333333" align="center" style="padding:0;Margin:0;">
                                                                  <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;line-height:150%;color:#333333;font-size:14px;font-size: 15px;"><strong><span style="color:#e9209b;">Identifiant </span>: '.$num_id.'</strong></p>
                                                                </td>
                                                              </tr>
                                                              <tr>
                                                                <td class="esd-block-text" align="center" style="padding:0;Margin:0;">
                                                                  <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;line-height:150%;color:#333333;font-size:14px;font-size: 15px;"><strong><span style="color:#e9209b;">Mot de passe </span>: '.$password.'</strong><br>
                                                                  </p>
                                                                </td>
                                                              </tr>
                                                            </tbody>
  ...
  if ($event == "to_mail") {
    ...
    if ($to_mail == 1) {
      ...
      mail($row_orders['email'], "=?utf-8?B?".base64_encode($subject)."?=", $msg, $mailheaders);
      //mail("hello@evput.com", "=?utf-8?B?".base64_encode($subject)."?=", $msg, $mailheaders);
    }
    echo"done";
  }
                                                ...
                                                <tr>
                                                  <td class="esd-container-frame" width="560" valign="top" align="center" style="padding:0;Margin:0;">
                                                    <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                      <tbody>
                                                        <tr>
                                                          <td class="esd-block-image" style="padding:0;Margin:0;font-size: 0px;" align="center"><a target="_blank" href="https://ftp.shootnbox.fr/template/" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2cb543;font-size:14px;"><img src="https://ftp.shootnbox.fr/manager/mail/btn.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;display: block;" width="276"></a></td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                  </td>
                                                  ...
                                                  <td class="esd-container-frame" width="560" valign="top" align="center" style="padding:0;Margin:0;">
                                                    <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td class="esd-block-text" esd-links-underline="none" esd-links-color="#333333" align="center" style="padding:0;Margin:0;">
                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;line-height:150%;color:#333333;font-size:14px;font-size: 15px;"><strong><span style="color:#e9209b;">Identifiant </span>: '.$row_orders['num_id'].'</strong></p>
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                          <td class="esd-block-text" align="center" style="padding:0;Margin:0;">
                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:\'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;line-height:150%;color:#333333;font-size:14px;font-size: 15px;"><strong><span style="color:#e9209b;">Mot de passe </span>: '.$row_orders['password'].'</strong><br>
                                                            </p>
                                                          </td>
                                                        </tr>
                                                      </tbody>
...
if ($event == "delete_image") {
  ...
  if ($event == "save_order_data") {
  	 mysqli_query($conn, "UPDATE `orders_new` SET `data` = '".str_replace('--', '==', $data)."' WHERE `id` = ".$order_id);
  }
    ...
    if ($order_id == 0) {
      ...
      mysqli_query($conn, "UPDATE `templates` SET `third_image` = '$file_name', `preview` = '$file_name2', `preview2` = '$file_name3', `data` = '".str_replace('--', '==', $json)."' WHERE `image` LIKE '$image'");
    	...
    	if (isset($_SESSION['order']['event_id'])) {
		    ...
		    file_put_contents('mydata.txt', $row_orders['template_id']." - ".$template_id);
  ...
  if ($event == "bornes_list") {
  	...
  	foreach ($prices_arr as $key => $value) {
  		switch($key) {
  			...
  			case 'ring_price_promotionnel': $title = "Ring_promotionnel"; $group = 1; break;
	  ...
	  if ($agency_id != 0) {
	  	...
	  	switch($box_type) {
            ...
            if (mysqli_num_rows($result_repair) == 0) {
  		 				if ($take_date != "") {
  	   					$show = true;
  	      			$result_orders = mysqli_query($conn, "SELECT * FROM `orders_new` WHERE `box_id` LIKE '%R$i/$prefix%'");
  	      			while($row_orders = mysqli_fetch_assoc($result_orders)) {
  	      				if ((strtotime(substr($take_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($take_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10))) || (strtotime(substr($return_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($return_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10)))) {
  	      					$show = false;
  	      				}
  	      			}
  	      			if ($show) {
  		 						$html .= '<option value="R'.$i.'/'.$prefix.'" >R'.$i.'/'.$prefix.'</option>';
  		 					}
  		 				} else {
  		 					$html .= '<option value="R'.$i.'/'.$prefix.'" >R'.$i.'/'.$prefix.'</option>';
  		 				}
	      ...
	      $content = "";
            ...
            if (mysqli_num_rows($result_repair) == 0) {
  	      		if ($take_date != "") {
  	   					$show = true;
  	      			$result_orders = mysqli_query($conn, "SELECT * FROM `orders_new` WHERE  `take_date` != '' AND `return_date` != '' AND `box_id` LIKE '%V$i/$prefix%'");
  	      			while($row_orders = mysqli_fetch_assoc($result_orders)) {
  	      				if ((strtotime(substr($take_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($take_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10))) || (strtotime(substr($return_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($return_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10)))) {
  	      					$show = false;
  	      				}
  	      			...
  	      			if ($show) {
  		 						$html .= '<option value="V'.$i.'/'.$prefix.'" >V'.$i.'/'.$prefix.'</option>';
  		 					}
  		 				} else {
  		 					$html .= '<option value="V'.$i.'/'.$prefix.'" >V'.$i.'/'.$prefix.'</option>';
  		 				}
            ...
            if (mysqli_num_rows($result_repair) == 0) {
  		 				if ($take_date != "") {
  	   					$show = true;
  	      			$result_orders = mysqli_query($conn, "SELECT * FROM `orders_new` WHERE `box_id` LIKE '%VS$i/$prefix%'");
  	      			while($row_orders = mysqli_fetch_assoc($result_orders)) {
  	      				if ((strtotime(substr($take_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($take_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10))) || (strtotime(substr($return_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($return_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10)))) {
  	      					$show = false;
  	      				}
  	      			...
  	      			if ($show) {
  		 						$html .= '<option value="vspace'.$i.'/'.$prefix.'" >VS'.$i.'/'.$prefix.'</option>';
  		 					}
  		 				} else {
  		 					$html .= '<option value="vspace'.$i.'/'.$prefix.'" >VS'.$i.'/'.$prefix.'</option>';
  		 				}
	      ...
	      case "Miroir_2000":
            ...
            if (mysqli_num_rows($result_repair) == 0) {
  	      		if ($take_date != "") {
  	   					$show = true;
  	      			$result_orders = mysqli_query($conn, "SELECT * FROM `orders_new` WHERE `box_id` LIKE '%M$i/$prefix%'");
  	      			while($row_orders = mysqli_fetch_assoc($result_orders)) {
  	      				if ((strtotime(substr($take_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($take_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10))) || (strtotime(substr($return_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($return_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10)))) {
  	      					$show = false;
  	      				}
  	      			...
  	      			if ($show) {
  		 						$html .= '<option value="M'.$i.'/'.$prefix.'" >M'.$i.'/'.$prefix.'</option>';
  		 					}
  		 				} else {
  		 					$html .= '<option value="M'.$i.'/'.$prefix.'" >M'.$i.'/'.$prefix.'</option>';
  		 				}
	      ...
	      break;
            ...
            if (mysqli_num_rows($result_repair) == 0) {
  						if ($take_date != "") {
  	   					$show = true;
  	      			$result_orders = mysqli_query($conn, "SELECT * FROM `orders_new` WHERE `box_id` LIKE '%S$i/$prefix%'");
  	      			while($row_orders = mysqli_fetch_assoc($result_orders)) {
  	      				if ((strtotime(substr($take_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($take_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10))) || (strtotime(substr($return_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($return_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10)))) {
  	      					$show = false;
  	      				}
  	      			...
  	      			if ($show) {
  		 						$html .= '<option value="S'.$i.'/'.$prefix.'" >S'.$i.'/'.$prefix.'</option>';
  		 					}
  		 				} else {
  		 					$html .= '<option value="S'.$i.'/'.$prefix.'" >S'.$i.'/'.$prefix.'</option>';
  		 				}
            ...
            if (mysqli_num_rows($result_repair) == 0) {
  						if ($take_date != "") {
  	   					$show = true;
  	      			$result_orders = mysqli_query($conn, "SELECT * FROM `orders_new` WHERE `box_id` LIKE '%VR$i/$prefix%'");
  	      			while($row_orders = mysqli_fetch_assoc($result_orders)) {
  	      				if ((strtotime(substr($take_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($take_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10))) || (strtotime(substr($return_date, 0, 10)) >= strtotime(substr($row_orders['take_date'], 0, 10)) && strtotime(substr($return_date, 0, 10)) <= strtotime(substr($row_orders['return_date'], 0, 10)))) {
  	      					$show = false;
  	      				}
  	      			...
  	      			if ($show) {
  		 						$html .= '<option value="VR'.$i.'/'.$prefix.'" >VR'.$i.'/'.$prefix.'</option>';
  		 					}
  		 				} else {
  		 					$html .= '<option value="VR'.$i.'/'.$prefix.'" >VR'.$i.'/'.$prefix.'</option>';
  		 				}
  ...
  if ($event == "options_list") {
  	if (strpos($select_type, 'entreprise') !== false) {
  		...
  		switch($box_type) {
	  		case "Ring":
	  		case "Ring_promotionnel": $options = $data['ring2']['options']; break;
	  		case "Vegas":
        case "Vegas_800":
        case "Vegas_1200":
        case "Vegas_1600":
        ...
        case "Miroir_2000": $options = $data['miroir']['options']; break;
  		...
  		switch($box_type) {
	  		case "Ring":
	  		case "Ring_promotionnel": $options = $data['ring']['options']; break;
	  		case "Vegas":
        case "Vegas_800":
        case "Vegas_1200":
        case "Vegas_1600":
  ...
  if ($event == "delivery_list") {
      ...
      //$box_type = 'Vegas';
  		switch($box_type) {
	  		case "Ring":
	  		case "Ring_promotionnel": $deliverys = $data['ring2']['delivery']; break;
	  		case "Vegas":
        case "Vegas_800":
        case "Vegas_1200":
        case "Vegas_1600":
        ...
        case "Miroir_2000": $deliverys = $data['miroir']['delivery']; break;
  		...
  		switch($box_type) {
	  		case "Ring":
	  		case "Ring_promotionnel": $deliverys = $data['ring']['delivery']; break;
        case "Vegas":
        case "Vegas_800":
	  		case "Vegas_1200":
        case "Vegas_1600":
  ...
  if ($event == "add_event") {
	...
	if ($event == "contour") {
  	...
  	$row_orders = mysqli_fetch_assoc($result_orders);
		$subject = "Contour photo (".$row_orders['num_id'].") ".$row_orders['last_name']." ".$row_orders['first_name']." ".date("d-m-Y H:i", time());
		$mailheaders = "MIME-Version: 1.0\r\n";
		$mailheaders.= "Content-Type: text/html; charset=utf-8\r\n";
		$mailheaders.= "From: =?utf-8?B?".base64_encode("ShootnBox")."?= <hello@shootnbox.fr>\r\n";
		$mailheaders.= "X-Mailer: PHP/".phpversion()."\r\n";
			                                        ...
			                                        <tbody>
			                                          <tr>
			                                            <td align="center" class="esd-block-text" style="padding:0;Margin:0;">
			                                              <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:150%;color: #707070; font-size: 19px;"><strong>'.$row_orders['last_name'].' '.$row_orders['first_name'].' - '.$row_orders['event_date'].' - '.$row_orders['box_type'].' a ajouté de nouvelles informations dans l’espace client.</strong></p>
			                                            </td>
			                                          </tr>
			                                        </tbody>
			                                      </table>
			                                        ...
			                                        <tbody>
			                                          <tr>
			                                            <td align="center" class="esd-block-text es-p15b" style="padding:0;Margin:0;padding-bottom:15px;">
			                                              <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:150%;font-size: 15px; color: #707070;"><strong><span style="color:#4DAD58;">Adresse mail : </span>'.$mail.'</strong></p>
			                                            </td>
			                                          </tr>
			                                          <tr>
			                                            <td align="center" class="esd-block-text es-p15b" style="padding:0;Margin:0;padding-bottom:15px;">
...
if ($event == "payment") {
    mysqli_query($conn, "UPDATE `orders_new` SET  `entreprise_pdf` = '$entreprise_pdf', `address_pdf` = '".htmlspecialchars($_POST['address_pdf'], ENT_QUOTES, 'UTF-8')."', `city_pdf` = '$city_pdf', `cp_pdf` = '$cp_pdf', `number_pdf` = '$number_pdf', `ord` = '$ord', `other_pdf` = '$other_pdf', `payment_by` = '".trim($payment_by, " / ")."', `payment_valid` = 1 WHERE id = ".$_SESSION['order']['id']) or die(mysqli_error($conn));
    $result_orders = mysqli_query($conn, "SELECT * FROM `orders_new` WHERE `id` = ".$_SESSION['order']['id']);
  	$row_orders = mysqli_fetch_assoc($result_orders);

     $subject = "INFOS PAIEMENT - ".$row_orders['num_id']." - Chanel - ".date("d/m/Y", time())." - ".$row_orders['box_type'];
     $mailheaders = "MIME-Version: 1.0\r\n";
     $mailheaders.= "Content-Type: text/html; charset=utf-8\r\n";
     ...
     $msg = '<!DOCTYPE html>
          ...
          <body>
            	<center>
	            	INFOS PAIEMENT - '.$row_orders['num_id'].' - Chanel - '.date("d/m/Y", time()).' - '.$row_orders['box_type'].'<br />
...
if ($event == "livraison") {
	$result_orders = mysqli_query($conn, "SELECT * FROM `orders_new` WHERE `id` = ".$_SESSION['order']['id']);
  	$row_orders = mysqli_fetch_assoc($result_orders);
    mysqli_query($conn, "UPDATE `orders_new` SET `take_date` = '".date("d.m.Y", strtotime($take_date))."', `take_time` = '$take_time', `event_place` = '$event_place', `take_contact` = '$take_contact', `take_access` = '$take_access', `take_stairs` = '$take_stairs', `return_date` = '".date("d.m.Y", strtotime($return_date))."', `return_time` = '$return_time', `return_place` = '$return_place', `return_contact` = '$return_contact', `return_access` = '$return_access', `return_stairs` = '$return_stairs', `plan_access` = '$plan_access', `delivery_valid` = 1 WHERE id = ".$_SESSION['order']['id']) or die(mysqli_error($conn));

    $subject = "CHANEL - ".date("d/m/Y", time())." - ".$row_orders['box_type']." a ajouté de nouvelles informations dans l'espace client";
     $mailheaders = "MIME-Version: 1.0\r\n";
     $mailheaders.= "Content-Type: text/html; charset=utf-8\r\n";
     $mailheaders.= "From: =?utf-8?B?".base64_encode("ShootnBox")."?= <contact@shootnbox.fr>\r\n";
     $mailheaders.= "X-Mailer: PHP/".phpversion()."\r\n";
     $msg = '<!DOCTYPE html>
          ...
          <body>
            	<center>
	            	CHANEL - '.date("d/m/Y", time()).' - '.$row_orders['box_type'].' a ajouté de nouvelles informations dans l\'espace client<br />
	            	...
	            	Jour de livraison : '.$take_date.'<br />
								...
								Contact(s) sur place : '.$event_place.'<br />
	            	...
	            	Jour de livraison : '.$return_date.'<br />
								...
								Contact(s) sur place : '.$return_place.'<br />
