...
<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
	<div class="panel-heading">
		...
		<h4 class="panel-title">Modifier les livraison</h4>
	</div>
	<div class="panel-body">
		<form class="form-horizontal edit-delivery">
        ...
        <div class="col-md-9" style="padding: 0 15px 15px 10px;">
          <div class="dropzone" id="dropzoneForm">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control title" value="<?php echo $row_delivery['title'] ?>" placeholder="<?php echo TITLE ?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label">Description</label>
				<div class="col-md-6">
					<textarea class="form-control description" placeholder="Description" style="height: 150px;"><?php echo htmlspecialchars_decode($row_delivery['description'], ENT_QUOTES) ?></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label">Description facture</label>
				<div class="col-md-6">
					<textarea class="form-control description_pdf" placeholder="Description facture" style="height: 50px;"><?php echo htmlspecialchars_decode($row_delivery['description_pdf'], ENT_QUOTES) ?></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label required">Particulier prix TTC, €</label>
				<div class="col-md-2">
					<input type="text" class="form-control numeric price" value="<?php echo $row_delivery['price'] ?>" placeholder="Particulier prix TTC, €" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label required">Entreprise prix HT, €</label>
				<div class="col-md-2">
					<input type="text" class="form-control numeric eprice" value="<?php echo $row_delivery['eprice'] ?>" placeholder="Entreprise prix HT, €" />
				</div>
			</div>
			<div class="form-group">
      ...
      init: function() {
            ...
            swal({
              ...
              if (data.value) {
                ...
                $.ajax({
                  type: 'POST',
                  url: 'd26386b04e.php',
                  data: {event: 'delete_image_delivery', id: <?php echo $_GET['option_id']; ?>},
                  cache: false,
		...
		$('.edit-delivery').on('submit', function(event){
			...
			$.ajax({
				type: 'POST',
				url: 'd26386b04e.php',
				data: {event: 'edit_delivery', id: <?php echo $delivery_id ?>, title: $('.title').val(), description: $('.description').val(), description_pdf: $('.description_pdf').val(), image: $('.image').val(), price: $('.price').val(), eprice: $('.eprice').val()},
				cache: false,
				success: function(responce){
					if (responce == 'done'){
						swal({
