	...
	<div class="panel-body">
		...
		<form class="form-horizontal edit-order">
			<div class="form-group">
				...
				<div class="col-md-2">
					<input type="text" class="form-control deposit" value="<?php echo $row_orders['deposit'] ?>" placeholder="Acompte, €" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label">Modalité de paiement</label>
        <div class="col-md-2">
          <select class="form-control payment_type1">
            <option value="0"<?php if ($row_orders['payment_type1'] == "0") {echo" selected";} ?>>Modalité de paiement...</option>
            <option value="1"<?php if ($row_orders['payment_type1'] == "1") {echo" selected";} ?>>CB</option>
            <option value="2"<?php if ($row_orders['payment_type1'] == "2" || $row_orders['payment_by'] == "Chèque") {echo" selected";} ?>>Chèque</option>
            <option value="3"<?php if ($row_orders['payment_type1'] == "3") {echo" selected";} ?>>Espèces</option>
            <option value="4"<?php if ($row_orders['payment_type1'] == "4" || $row_orders['payment_by'] == "Virement") {echo" selected";} ?>>Virement</option>
            <option value="5"<?php if ($row_orders['payment_type1'] == "5") {echo" selected";} ?>>Mollie</option>
            <option value="6"<?php if ($row_orders['payment_type1'] == "6" || $row_orders['payment_by'] == "Chorus") {echo" selected";} ?>>Chorus</option>
          </select>
        </div>
			</div>
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control rest" value="<?php echo ($row_orders['total']*1.2 - $row_orders['deposit']) ?>" placeholder="Solde, €" readonly />
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-3 control-label">Modalité de paiement</label>
        <div class="col-md-2">
          <select class="form-control payment_type2">
            ...
            <option value="2"<?php if ($row_orders['payment_type2'] == "2" || $row_orders['payment_by'] == "Chèque") {echo" selected";} ?>>Chèque</option>
            <option value="3"<?php if ($row_orders['payment_type2'] == "3") {echo" selected";} ?>>Espèces</option>
            <option value="4"<?php if ($row_orders['payment_type2'] == "4" || $row_orders['payment_by'] == "Virement") {echo" selected";} ?>>Virement</option>
            <option value="5"<?php if ($row_orders['payment_type2'] == "5") {echo" selected";} ?>>Mollie</option>
            <option value="6"<?php if ($row_orders['payment_type2'] == "6" || $row_orders['payment_by'] == "Chorus") {echo" selected";} ?>>Chorus</option>
          </select>
        </div>
      </div>
      <div class="form-group">
    ...
    $('.take_date, .return_date').datepicker({
      ...
      if ($('.payment_type1').val() == 0) {
        ...
        return false;
          ...
          deposit: $('.deposit').val(),
					payment_status: $('.payment_status2').val() != 2 ? $('.payment_status').val() : $('.payment_status2').val(),
          ...
          return_date: $('.return_date').val(),
              ...
              <?php } else { ?>
                window.location.href = 'epayments.php';
              <?php } ?>
						});
					} else {
						showError(responce);
