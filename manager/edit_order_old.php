      ...
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="number" class="form-control cp" value="<?php echo (isset($row_orders['cp']) ? $row_orders['cp'] : '') ?>" placeholder="Code postal" />
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control email" value="<?php echo $row_orders['email'] ?>" placeholder="E-mail" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label">Téléphone</label>
				<div class="col-md-4">
					<input type="tel" class="form-control phone" value="<?php echo $row_orders['phone'] ?>" placeholder="Téléphone" />
				</div>
			</div>
			<div class="form-group">
        <label class="col-md-3 control-label"></label>
          ...
          <label class="control-label"><b>Devis N°</b></label>
					<input type="text" class="form-control num_id" value="<?php echo ($row_orders['num_id'] != '' ? $row_orders['num_id'] : 'DE'.($orders_amount + 5000)) ?>" placeholder="Devis N" />
				</div>
        <div class="col-md-2">
