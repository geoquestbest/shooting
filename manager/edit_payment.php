	...
	<div class="panel-body">
        ...
        <div class="col-md-2">
          <select class="form-control payment_type1">
            ...
            <option value="2"<?php if ($row_orders['payment_type1'] == "2") {echo" selected";} ?>>Chèque</option>
            <option value="3"<?php if ($row_orders['payment_type1'] == "3") {echo" selected";} ?>>Espèces</option>
            <option value="4"<?php if ($row_orders['payment_type1'] == "4") {echo" selected";} ?>>Virement</option>
      ...
      <div class="form-group">
        ...
        <div class="col-md-2">
          <input type="text" class="form-control rest" value="<?php echo ($row_orders['total'] - $row_orders['deposit']) ?>" placeholder="Solde, €" readonly />
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-3 control-label">Modalité de paiement</label>
      ...
      if ($('.payment_type1').val() == 0) {
        ...
        return false;
          ...
          return_date: $('.return_date').val(),
              ...
              <?php if ($_GET['status'] != "") { ?>
							window.location.href = 'payments_list.php?status=<?php echo $_GET['status'] ?>';
              <?php } else { ?>
