		...
		<table id="data-table" class="table table-striped table-bordered orders-table nowrap" width="100%">
            ...
            $template = ADMIN_UPLOAD_IMAGES_DIR.$row_gallery_videos['video'];
               ...
               echo'</td>
								...
								echo'</td>
								<td class="text-center">
		              <a href="configure.php?order_id='.$row_orders['id'].'&vegas=true&back_url='.$_SERVER['REQUEST_URI'].'" class="btn btn-warning btn-icon btn-circle btn-lg" title="Configuration 1"><i class="fa fa-edit"></i></a>&nbsp;
		              ...
		              <a href="vegas/?image=../'.$template.'&order_id='.$row_orders['id'].'&vegas=true&data='.$row_orders['data'].'" class="btn btn-danger btn-icon btn-circle btn-lg" title="Configuration 2"><i class="fa fa-edit"></i></a>
		             </td>
								<td>';
