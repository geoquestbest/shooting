...
<script>
    ...
    $('.show').on('click', function(event) {
      ...
      if ($('.start_date').val() != '' && $('.end_date').val() != '') {
        window.location.href = 'orders_list.php?status=<?php echo mysqli_real_escape_string($conn, $_GET['status']); if (isset($_GET['arch'])) { echo"&arch=true"; } ?>&start_date=' + $('.start_date').val() + '&end_date=' + $('.end_date').val() + '&search_type=' + $('.search_type').val();
      }
    });
    ...
    $('.user_id').on('change', function(event) {
      event.preventDefault();
      if ($('.start_date').val() != '' && $('.end_date').val() != '') {
        window.location.href = 'orders_list.php?status=<?php echo mysqli_real_escape_string($conn, $_GET['status']); if (isset($_GET['arch'])) { echo"&arch=true"; } ?>&start_date=' + $('.start_date').val() + '&end_date=' + $('.end_date').val() + '&user_id=' + $('.user_id').val() + '&search_type=' + $('.search_type').val();
      } else {
        window.location.href = 'orders_list.php?status=<?php echo mysqli_real_escape_string($conn, $_GET['status']); if (isset($_GET['arch'])) { echo"&arch=true"; } ?>&user_id=' + $('.user_id').val() + '&search_type=' + $('.search_type').val();
      }
    });
